...
def set_monitor_lstm_model(
    ...
    _MONITOR = "loss"
    _PATIENCE = 20    
    monitor = EarlyStopping(monitor=_MONITOR, patience=_PATIENCE, verbose=_VERBOSE, mode="auto", 
...
def fit_lstm_model(
    ...
    history = model.fit(X_train_total, y_train, validation_data=(X_test_total, y_test),
